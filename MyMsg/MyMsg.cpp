...
// MyMsg.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMyMsgApp, CWinApp)
...
// Единственный объект CMyMsgApp

CMyMsgApp theApp;


// инициализация CMyMsgApp

BOOL CMyMsgApp::InitInstance()
{
